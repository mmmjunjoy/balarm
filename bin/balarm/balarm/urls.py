...
from alarm.views import UserbungryListAPI , AlarmAPI , DateAlarmAPI ,DateAlarmDetailAPI, CustomLoginView, UserbungrySignUpView, SaveFCMTokenView, WithdrawView, LogoutView , GenerateGroupCodeView,CreateGroupView,JoinGroupView, LeaveGroupView , GroupInfoView
...
urlpatterns = [
    ...
    path('api/groupinfo/', GroupInfoView.as_view()),
